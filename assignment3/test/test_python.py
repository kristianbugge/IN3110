...
def test_color2gray():
    ...
    # run color2gray
    out_image = python_color2gray(in_image)
    ...
    assert int(expectedVal1) == out_image[randX1][randY1][0]
    assert int(expectedVal1) == out_image[randX1][randY1][1]
    assert int(expectedVal1) == out_image[randX1][randY1][2]

    assert int(expectedVal2) == out_image[randX2][randY2][0]
    assert int(expectedVal2) == out_image[randX2][randY2][1]
    assert int(expectedVal2) == out_image[randX2][randY2][2]
...
def test_color2sepia(image):
    ...
    # run color2sepia
    out_image = python_color2sepia(in_image)
